...
describe("Bounded Knapsack Problem", () => {
  it("should solve bounded knapsack problem", () => {
    ...
    expect(knapsackProblemBounded(knapsackItems, 17)).toBe(84 + 84 + 20 + 10);
  });
  ...
  it("should solve bounded knapsack problem max weight more than sum of all items", () => {
    ...
    expect(knapsackProblemUnbounded(knapsackItems, 60)).toBe(712);
  });
});
